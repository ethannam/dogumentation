...
scooby_doo = Dog.create(name: "Scooby Doo", breed: "Great Dane", birthday: Date.new(1969,1,1), user_id: shaggy.id, size: "large", username: "scoobydoo")
dug = Dog.create(name: "Dug", breed: "Golden Retriever", birthday: Date.new(2009,5,29), user_id: charlie.id, size: "medium", username: "dug")
spot = Dog.create(name: "Spot", breed: "Dalmation", birthday: Date.new(2008,3,21), user_id: john.id, size: "medium", username: "spot")
