...
shaggy = User.create(first_name: "Shaggy", last_name: "Rogers", phone_num: "555-867-5309", email: "shaggy@gmail.com", username: "shaggy", password_digest: "")
charlie = User.create(first_name: "Charlie", last_name: "Muntz", phone_num: "555-867-5443", email: "charlie@gmail.com", username: "charlie", password_digest: "")
